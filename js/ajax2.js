    ...
    $.ajax({
        ...
        success: function(jsonData){
            ...
            var tempList = {
                ...
                creatorName: jsonData.data.creator.nickname,   // 列表创建者名字
                creatorAvatar: jsonData.data.creator.avatarUrl,   // 列表创建者头像
                item: []
            };
            ...
            if(typeof jsonData.data.items !== undefined || jsonData.data.items.length !== 0) {
                ...
                for (var i = 0; i < jsonData.data.items.length; i++) {
                    tempList.item[i] =  {
                        ...
                        artist: jsonData.data.items[i].artists[0].name, // 艺术家名字
